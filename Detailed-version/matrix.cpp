...
matrix3f matrix3f::rotxyz(const vect3f& euler)
{
	matrix3f ret;
	float a = (float)cos(euler.v[0]);
	float b = (float)sin(euler.v[0]);
	float c = (float)cos(euler.v[1]);
	float d = (float)sin(euler.v[1]);
	float e = (float)cos(euler.v[2]);
	float f = (float)sin(euler.v[2]);
...
matrix3f matrix3f::rotaxis(const vect3f& axis, float rad)
{
	matrix3f ret;
	float c = cos(rad);
	float s = sin(rad);
...
vect3f matrix3f::mult(const vect3f& src) const
{
	vect3f ret;
...
matrix4f matrix4f::rotxyz(const vect3f& euler)
{
	matrix4f ret;
	float a = (float)cos(euler.v[0]);
	float b = (float)sin(euler.v[0]);
...
matrix4f matrix4f::rotaxis(const vect3f& axis, float rad)
{
	matrix4f ret;
	float c = cos(rad);
	float s = sin(rad);
...
vect3f matrix4f::mult_pos(const vect3f& src) const
{
	vect3f ret;
...
vect3f matrix4f::mult_vec(const vect3f& src) const
{
	vect3f ret;
